...
@BeforeTest
	public  void launchbrowser() throws InterruptedException {
		...
		Thread.sleep(2000);
Wait<WebDriver> wait1= new FluentWait<>(driver).withTimeout(Duration.ofSeconds(10)).pollingEvery(Duration.ofSeconds(10)).ignoreAll(ElementNotInteractableException.class);
WebDriverWait waity=new FluentWait<>(driver);
wait1.until(null)
	}
@Test(priority=1)
